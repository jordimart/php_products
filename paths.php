<?php
    ...
    define('PRODUCTS_JS_LIB_PATH', SITE_PATH . '/modules/page_products/view/lib/');
    define('PRODUCTS_JS_PATH', SITE_PATH . '/modules/page_products/view/js/'); 
    define('PRODUCTS_CSS_PATH', SITE_PATH . '/modules/page_products/view/css/');
